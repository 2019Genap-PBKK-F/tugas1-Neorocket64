    ...
    load() {
      axios.get('http://localhost:8024/api/capaian_unit/').then(res => {
        ...
        var options = {
          ...
          responsive: true,
          columns: [
            { type: 'dropdown', title: 'Data Dasar', width: '120px', url: 'http://localhost:8024/api/datadasar/', autocomplete: true },
            { type: 'dropdown', title: 'Unit', width: '120px', url: 'http://localhost:8024/api/unitname/', autocomplete: true },
